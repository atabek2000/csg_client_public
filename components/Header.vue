<template>
  <div class="head">
    ...
    <div class="header" :style="'background-color: rgba(1, 59, 130, 1);'">
        ...
        <li class="nav-item">
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              <NuxtLink
                to="/our"
                :class="$route.path == '/our' ? 'menu-active' : ''"
                >{{ $t("headerMain.h1") }}</NuxtLink
              >
              <NuxtLink
                to="/production"
                :class="$route.path == '/production' ? 'menu-active' : ''"
                >{{ $t("headerMain.h2") }}</NuxtLink
              >
              <NuxtLink
                to="/partners"
                :class="$route.path == '/partners' ? 'menu-active' : ''"
                >{{ $t("headerMain.h3") }}</NuxtLink
              >
              <NuxtLink
                to="/projects"
                :class="$route.path == '/projects' ? 'menu-active' : ''"
                >{{ $t("headerMain.h4") }}</NuxtLink
              >
              <NuxtLink
                to="/montage"
                :class="$route.path == '/montage' ? 'menu-active' : ''"
                >{{ $t("headerMain.h5") }}</NuxtLink
              >
            </div>
          </div>
        </li>
        ...
        <div class="nav-item">
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              <NuxtLink
                to="/delivery"
                :class="$route.path == '/delivery' ? 'menu-active' : ''"
                >{{ $t("headerMain.h8") }}</NuxtLink
              >
              <NuxtLink
                to="/payment"
                :class="$route.path == '/payment' ? 'menu-active' : ''"
                >{{ $t("headerMain.h9") }}</NuxtLink
              >
              <NuxtLink
                to="/install"
                :class="$route.path == '/install' ? 'menu-active' : ''"
                >{{ $t("headerMain.h10") }}</NuxtLink
              >
              <NuxtLink
                to="/refund"
                :class="$route.path == '/refund' ? 'menu-active' : ''"
